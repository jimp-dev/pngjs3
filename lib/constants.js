...
export const TYPE_tRNS = 0x74524e53; // eslint-disable-line camelcase
export const TYPE_gAMA = 0x67414d41; // eslint-disable-line camelcase

// color-type bits
export const COLORTYPE_GRAYSCALE = 0;
export const COLORTYPE_PALETTE = 1;
export const COLORTYPE_COLOR = 2;
export const COLORTYPE_ALPHA = 4; // e.g. grayscale and alpha

// color-type combinations
export const COLORTYPE_PALETTE_COLOR = 3;
export const COLORTYPE_COLOR_ALPHA = 6;

export const COLORTYPE_TO_BPP_MAP = {
  0: 1,
  2: 3,
  3: 1,
  4: 2,
